                ...
                <div id="modal1" class="modal">
                    ...
                    <div class="modal-footer">
                        <form action="{{ route('user.destroy') }}" method="POST">
                            ...
                            @csrf
                            <a href="#!"
                                class="modal-close waves-effect waves-green btn-flat cyan white-text ">Cancelar</a>
                            <button
                                class="modal-close waves-effect waves-green btn-flat red white-text ">Eliminar</button>
                        </form>
                    </div>
                </div>
            </div>
