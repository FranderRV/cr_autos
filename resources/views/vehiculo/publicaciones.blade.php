    ...
    <div class="container-fluid white">
        <div class="container">
            <div class="fixed-action-btn">
                <a class="tooltipped btn-floating btn-large red pulse " data-position="left"
                    data-tooltip="Insertar vehículo" href="{{ route('vehiculo.create') }}">
                            ...
                            @if ($carro['vendedorId'] == json_decode(Cookie::get('usuario'), true)['id'])
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="card-action p-5">
                                                        ...
                                                        <a class=" btn waves-effect waves-light light-blue accent-3"
                                                            href="{{ route('vehiculo.show', $carro['id']) }}"
                                                            type="submit">
                                                        ...
                                                        @if (Cookie::get('usuario') !== null)
                                                            @if (json_decode(Cookie::get('usuario'), true)['id'] == $carro['vendedorId'])
                                                                ...
                                                                <a class="btn waves-effect waves-light light-green accent-4"
                                                                    href="{{ route('vehiculo.edit', $carro['id']) }}"
                                                                    type="submit">
                                ...
                                <div id="modal1" class="modal modal">
                                    <div class="modal-content">
                                        ...
                                        <p>Si se elimina no hay vuelta atrás</p>
                                    </div>
                                    <div class="modal-footer">
                                        <form action="{{ route('vehiculo.destroy', $carro['id']) }}" method="POST">
                                            ...
                                            <a class="btn waves-effect waves-light cyan modal-close">
                                                Cancelar</a>
